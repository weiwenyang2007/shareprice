...
-- Table: CANDLESTICK_PATTERN

-- DROP TABLE CANDLESTICK_PATTERN;

CREATE TABLE CANDLESTICK_PATTERN
(
  stockId text NOT NULL,
  date text NOT NULL,
  pattern text,
...
ALTER TABLE CANDLESTICK_PATTERN
  OWNER TO postgres;
COMMENT ON TABLE CANDLESTICK_PATTERN
  IS 'CANDLESTICK_PATTERN';