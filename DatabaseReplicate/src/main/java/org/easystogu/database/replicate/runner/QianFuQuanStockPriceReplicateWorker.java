...
public class QianFuQuanStockPriceReplicateWorker {
	public String fromDate = WeekdayUtil.currentDate();
	public String toDate = WeekdayUtil.currentDate();
	private QianFuQuanStockPriceTableHelper localTable = QianFuQuanStockPriceTableHelper.getInstance();
	private QianFuQuanStockPriceTableHelper georedTable = QianFuQuanStockPriceTableHelper.getGeoredInstance();
	...
	public void runForDate(String date) {
		...
		System.out.println("Checking QianFuQuanStockPriceTable at " + date);
	...
	public static void main(String[] args) {
		QianFuQuanStockPriceReplicateWorker worker = new QianFuQuanStockPriceReplicateWorker();
