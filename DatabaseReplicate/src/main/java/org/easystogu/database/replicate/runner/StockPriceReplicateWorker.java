...
public class StockPriceReplicateWorker {
	public String fromDate = WeekdayUtil.currentDate();
	public String toDate = WeekdayUtil.currentDate();
	private StockPriceTableHelper localTable = StockPriceTableHelper.getInstance();
	private StockPriceTableHelper georedTable = StockPriceTableHelper.getGeoredInstance();
	...
	public void runForDate(String date) {
		...
		System.out.println("Checking StockPriceTable at " + date);
	...
	public static void main(String[] args) {
		StockPriceReplicateWorker worker = new StockPriceReplicateWorker();
