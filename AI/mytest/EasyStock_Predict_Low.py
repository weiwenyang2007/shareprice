...
# Load data
szzsHigh = pd.read_csv(os.path.join(BASE_PATH, "999999_low.csv"), usecols=[0,1])
...
qsddP = [[0.005,0.003,0.004]] # 2020-02-04
...
wrP = [[0.014,0.001,0.491]] # 2020-02-03
...
qsddWrP = [[0.005,0.003,0.004,0.009,0.166,0.002]] # 2020-02-04
print("QSDD & WR Predict should return -1: %d" % clf.predict(qsddWrP))# -1
