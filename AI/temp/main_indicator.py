...
from train_indicator import StockTrainHandler
...
if __name__ == "__main__":
    ...
    train_indicator = StockTrainHandler(stock_id, train_from_scratch, useCkpId)
    ...
    test_pred, df_test_with_date = train_indicator.train_model()
